...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'lib.data';
    var REMOTE_PACKAGE_BASE = 'lib.data';
...
Module['FS_createPath']('/programs', 'binaries', true, true);
        ...
        DataRequest.prototype.byteArray = Module['HEAPU8'].subarray(ptr, ptr+byteArray.length);
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_lib.data');

    };
    Module['addRunDependency']('datafile_lib.data');
 ...
 loadPackage({"files": [{"audio": 0, "start": 0, "crunched": 0, "end": 4096, "filename": "/programs/binaries/Apple1Basic.bin"}, {"audio": 0, "start": 4096, "crunched": 0, "end": 4107, "filename": "/programs/binaries/ConsoleCharacterTest.bin"}, {"audio": 0, "start": 4107, "crunched": 0, "end": 4363, "filename": "/programs/binaries/WozMonitor.bin"}], "remote_package_size": 4363, "package_uuid": "46e77064-3112-421d-9d39-b9b40be65b6e"});
...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'lib.wast';
  var wasmBinaryFile = 'lib.wasm';
  var asmjsCodeFile = 'lib.temp.asm.js';
...
function _print_to_screen(character){ print(character); }
...
/* global initializers */  __ATINIT__.push({ func: function() { __GLOBAL__sub_I_AppleIWebEmulator_cpp() } }, { func: function() { __GLOBAL__sub_I_bind_cpp() } });
...
Module['wasmTableSize'] = 8256;

Module['wasmMaxTableSize'] = 8256;
...
var real____em_js__print_to_screen = asm["___em_js__print_to_screen"]; asm["___em_js__print_to_screen"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__print_to_screen.apply(null, arguments);
};
...
Module["asm"] = asm;
var __GLOBAL__sub_I_AppleIWebEmulator_cpp = Module["__GLOBAL__sub_I_AppleIWebEmulator_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_AppleIWebEmulator_cpp"].apply(null, arguments) };
...
var ___em_js__print_to_screen = Module["___em_js__print_to_screen"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__print_to_screen"].apply(null, arguments) };
